...
%token <symp>IDENTIFIER STRING_LITERAL PUNCTUATORS COMMENT
%token <intval>INT_CONSTANT FLOAT_CONSTANT ENU_CONSTANT 
%token <char>CHAR_CONSTANT

%start translation_unit

%type <symp> additive_expression multiplicative_expression cast_expression unary_expression
%type <symp> postfix_expression primary_expression constant
